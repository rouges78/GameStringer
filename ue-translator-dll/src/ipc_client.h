...
public:
    ...
    void ProcessMessages() {
        ...
        // Parse comando (semplificato)
        std::string msg(buffer);
        if (msg.find("\"type\":\"toggle\"") != std::string::npos) {
            // Toggle traduzione - gestito esternamente
            extern void ToggleTranslation();
            ToggleTranslation();
        } else if (msg.find("\"type\":\"clear_cache\"") != std::string::npos) {
