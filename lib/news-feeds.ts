...
export const DEFAULT_FEED_SOURCES: NewsFeedSource[] = [
  ...
  { id: 'romhackplaza', name: 'RomHack Plaza', url: 'https://romhackplaza.org', rssUrl: 'https://romhackplaza.org/feed/', category: 'translations', icon: '🌍', enabled: false, language: 'en', description: 'Hacks, fan translations and homebrew games (RSS non disponibile: il sito risponde, il feed da 404 — verificato 23/08/2026 anche su /rss)' },
  // ── Nuove fonti aggiunte 2026-05-20 (abilitate 2026-07-04 per test in app) ──
  { id: 'ctrltrad', name: 'Ctrl+Trad', url: 'https://ctrltrad.itch.io', rssUrl: 'https://ctrltrad.itch.io/devlog.rss', category: 'translations', icon: '🇮🇹', enabled: false, language: 'it', description: 'Creator italiano di patch ITA per giochi Steam/GOG indie e AA non localizzati. RSS non disponibile: su itch.io il devlog.rss esiste per le pagine GIOCO, non per il profilo utente — verificato 23/08/2026, sito 200 e feed 404' },
  { id: 'oldgamesitalia', name: 'OldGamesItalia', url: 'https://www.oldgamesitalia.net/forum/', rssUrl: 'https://www.oldgamesitalia.net/feed', category: 'translations', icon: '🇮🇹', enabled: true, language: 'it', description: 'Storica community italiana di traduzioni amatoriali e retrogaming. 23/08/2026: il feed del FORUM (Invision) restituiva HTML, non XML — la voce era attiva ma non poteva funzionare. Il feed del sito risponde: 10 voci, application/rss+xml' },
