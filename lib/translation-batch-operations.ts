...
function formatAsCSV(translations: unknown[], options: ExportOptions): string {
  const headers = [
    'ID',
    'Game',
    'File Path',
...
function formatAsXLSX(translations: unknown[], options: ExportOptions): unknown {
...
function formatAsPO(translations: unknown[], options: ExportOptions): string {
