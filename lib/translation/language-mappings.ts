...
export const PROVIDER_LABELS: Record<string, string> = {
  ...
  gemini: 'Google Gemini 3.5 Flash (Frontier — I/O 2026)',
  'gemini-3.1': 'Google Gemini 3.1 Flash-Lite (Long Context, low-cost)',
  ...
  'anthropic-premium': 'Anthropic Claude Opus 4.8 (Premium — max qualità)',
  mistral: 'Mistral AI',
  cohere: 'Cohere',
...
export const API_KEY_URLS: Record<string, string> = {
  ...
  'anthropic-premium': 'https://console.anthropic.com/settings/keys',
