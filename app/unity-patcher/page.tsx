      ...
      <div className="relative overflow-hidden rounded-xl bg-gradient-to-br from-emerald-700 via-teal-600 to-cyan-700 p-3">
        ...
        <div className="relative flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg font-bold text-white drop-shadow-[0_2px_4px_rgba(0,0,0,0.9)]">Game Patcher</h2>
              <p className="text-white/90 text-[10px] drop-shadow-[0_1px_3px_rgba(0,0,0,0.9)]">Automatic patches for Unity, Unreal and other engines</p>
            </div>
          </div>
          ...
          <div className="hidden md:flex items-center gap-4">
            <div className="flex items-center gap-1 text-white drop-shadow-[0_1px_2px_rgba(0,0,0,0.8)]">
              ...
              <span className="text-[10px] text-white/80">Engine</span>
            </div>
            <div className="flex items-center gap-1 text-white drop-shadow-[0_1px_2px_rgba(0,0,0,0.8)]">
              <Zap className="h-3 w-3" />
              <span className="text-sm font-bold">Auto</span>
              <span className="text-[10px] text-white/80">Install</span>
            </div>
            <div className="flex items-center gap-1 text-white drop-shadow-[0_1px_2px_rgba(0,0,0,0.8)]">
              <Shield className="h-3 w-3" />
              <span className="text-sm font-bold">Safe</span>
              <span className="text-[10px] text-white/80">Backup</span>
            </div>
          </div>
        </div>
        ...
        <div className="relative flex flex-wrap items-center gap-2 mt-2 pt-2 border-t border-white/20">
          <span className="text-[10px] text-white/80 drop-shadow-[0_1px_2px_rgba(0,0,0,0.8)] mr-1">Other patchers:</span>
