...
const OCRImageProcessor: React.FC<OCRImageProcessorProps> = ({
  ...
  // Simula processamento OCR (in produzione useresti Tesseract.js o API esterna)
...
anche in condizioni di illuminazione non ottimali.`,
  ...
  const handleFileUpload = useCallback(async (files: FileList | null) => {
    ...
    try {
      ...
      // Filtra risultati per confidenza minima
      ...
      toast.success(`Testo estratto con confidenza ${result.confidence.toFixed(1)}%`);
    } catch (error) {
      console.error('Errore OCR:', error);
      toast.error('Errore durante il processamento dell\'immagine');
    } finally {
  ...
  return (
    <div className={`space-y-6 ${className}`}>
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold">OCR Processore Immagini</h2>
          <p className="text-muted-foreground">
            Estrai testo da screenshot e immagini di gioco
          </p>
        </div>
        ...
        <Dialog open={isSettingsOpen} onOpenChange={setIsSettingsOpen}>
          ...
          <DialogContent className="max-w-2xl">
            <DialogHeader>
              <DialogTitle>Impostazioni OCR</DialogTitle>
              <DialogDescription>
                Configura le opzioni di riconoscimento testo
              </DialogDescription>
            </DialogHeader>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-2">
                <Label>Lingua di Riconoscimento</Label>
                <Select 
              ...
              <div className="space-y-2">
                <Label>Modalità Rilevamento</Label>
                <Select 
                ...
                >
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="accurate">Accurato</SelectItem>
              ...
              {/* Confidenza minima */}
              <div className="space-y-2">
                <Label>Confidenza Minima: {settings.minConfidence}%</Label>
                <Slider
      ...
      {results.length > 0 && (
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <h3 className="text-lg font-semibold">Risultati OCR</h3>
            <div className="flex items-center gap-2">
              <Button
                variant="outline"
                size="sm"
              ...
              >
                ...
                {showBoundingBoxes ? 'Nascondi' : 'Mostra'} Box
              </Button>
            </div>
          </div>
