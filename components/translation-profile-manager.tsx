  ...
  return (
    <div className="space-y-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">
                {statistics.officialProfiles} ufficiali
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">
                ~{Math.round(statistics.averageTranslationsPerProfile)} per profilo
              </p>
            </CardContent>
          </Card>
      ...
      <div className="flex flex-col md:flex-row gap-4">
        <div className="flex-1">
          <div className="relative">
            ...
            <Input
              type="text"
              placeholder="Cerca profili per nome, gioco o tag..."
              value={searchQuery}
          ...
          <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
            ...
            <DialogContent className="sm:max-w-[500px]">
              <DialogHeader>
                ...
                <DialogDescription>
                  Crea un nuovo profilo di traduzione per un gioco
                </DialogDescription>
              </DialogHeader>
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    placeholder="Es: hollow_knight.exe"
                  />
                </div>
                <div className="space-y-2">
                  <Label>Lingua</Label>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    placeholder="Es: rpg, fantasy, indie"
                  />
                </div>
              </div>
              <DialogFooter>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  <CardContent className="pt-0">
                    <div className="space-y-2">
                      <p className="text-sm text-muted-foreground line-clamp-2">
                        {profile.metadata.description || 'Nessuna descrizione'}
                      </p>
                      <div className="flex items-center justify-between text-xs text-muted-foreground">
                        <span>{profile.translations.length} traduzioni</span>
                        <span>Aggiornato: {formatDate(profile.metadata.updatedAt)}</span>
                      </div>
        ...
        <div className="space-y-4">
          <h3 className="text-lg font-semibold">Dettagli Profilo</h3>
          {selectedProfile ? (
            <Card>
              <CardHeader>
                <CardTitle>{selectedProfile.gameName}</CardTitle>
                <CardDescription>
                  {selectedProfile.metadata.description || 'Nessuna descrizione'}
                </CardDescription>
              </CardHeader>
              <CardContent>
                <Tabs defaultValue="translations">
                  ...
                  <TabsContent value="translations" className="space-y-4">
                    <div className="flex justify-between items-center">
                      <p className="text-sm text-muted-foreground">
                        {selectedProfile.translations.length} traduzioni
                      </p>
                      <Button
                        size="sm"
                        onClick={() => {
                  ...
                  <TabsContent value="info" className="space-y-4">
                    <div className="space-y-3">
                      ...
                      <div>
                        <Label className="text-sm">Autore</Label>
                        <p className="text-sm text-muted-foreground">
                          {selectedProfile.metadata.author || 'Sconosciuto'}
                        </p>
                      </div>
                      <div>
                        <Label className="text-sm">Creato</Label>
                        <p className="text-sm text-muted-foreground">
                          {formatDate(selectedProfile.metadata.createdAt)}
                        </p>
                      </div>
                      <div>
                        <Label className="text-sm">Ultimo Aggiornamento</Label>
                        <p className="text-sm text-muted-foreground">
      ...
      <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
        <DialogContent className="max-w-3xl max-h-[80vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription>
              Modifica le traduzioni e le impostazioni del profilo
            </DialogDescription>
          </DialogHeader>
          {editingProfile && (
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center">
                  <Label>Traduzioni ({editingProfile.translations.length})</Label>
                  <div className="flex gap-2">
                    <Input
