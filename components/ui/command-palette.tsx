...
export function CommandPalette() {
  ...
  const commands: CommandItem[] = useMemo(() => [
    ...
    { id: 'guide', title: 'Guida', description: 'Guida utente GameStringer', icon: <FolderOpen className="h-4 w-4" />, action: () => router.push('/guide'), keywords: ['guide', 'help', 'guida'], category: 'navigation' },
