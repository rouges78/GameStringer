  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between p-4 bg-gradient-to-r from-purple-500/10 via-blue-500/10 to-cyan-500/10 border-b border-slate-700/50">
                  ...
                  {isSelectMode && selectedNotifications.size > 0 ? (
                    <>
                      <DropdownMenuItem onClick={handleSelectAll}>
                        ...
                        {selectedNotifications.size === processedNotifications.length ? 'Deselect all' : 'Select all'}
                      </DropdownMenuItem>
                      <DropdownMenuSeparator />
      ...
      <div className="flex items-start space-x-3">
        ...
        <div className="flex-shrink-0 text-lg" aria-hidden="true">
          {notification.icon ? (
            ...
            <span role="img" aria-label={`${notification.type.toLowerCase()} icon`}>
