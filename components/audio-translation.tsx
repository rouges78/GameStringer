...
interface AudioTranslation {
  ...
  confidence: number;
  timestamp: Date;
  audioUrl?: string; // URL dell'audio tradotto (TTS)
}
...
const AudioTranslation: React.FC<AudioTranslationProps> = ({
  ...
  useEffect(() => {
    const getAudioDevices = async () => {
      try {
        ...
        console.error('Errore nel recupero dispositivi audio:', error);
      }
    };
  ...
  const processAudio = async (audioBlob: Blob) => {
    ...
    try {
      ...
      // Traduzione automatica se abilitata
      ...
      toast.success('Audio processato con successo');
    } catch (error) {
  ...
  return (
    <div className={`space-y-6 ${className}`}>
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold">Traduzione Audio</h2>
          <p className="text-muted-foreground">
            Trascrivi e traduci audio e dialoghi di gioco
          </p>
        </div>
        ...
        <Dialog open={isSettingsOpen} onOpenChange={setIsSettingsOpen}>
          ...
          <DialogContent className="max-w-2xl">
            <DialogHeader>
              <DialogTitle>Impostazioni Audio</DialogTitle>
              <DialogDescription>
                Configura le opzioni di registrazione e traduzione
              </DialogDescription>
            </DialogHeader>
            ...
            <Tabs defaultValue="recording" className="w-full">
              <TabsList className="grid w-full grid-cols-3">
                ...
                <TabsTrigger value="translation">Traduzione</TabsTrigger>
                <TabsTrigger value="voice">Voce</TabsTrigger>
              </TabsList>

              <TabsContent value="recording" className="space-y-4">
                <div className="space-y-2">
                  <Label>Dispositivo Input</Label>
                  <Select 
              ...
              <TabsContent value="translation" className="space-y-4">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    <Label>Traduzione Automatica</Label>
                    <Switch
              ...
              <TabsContent value="voice" className="space-y-4">
                ...
                {settings.enableTTS && (
                  <>
                    <div className="space-y-2">
                      <Label>Velocità Voce: {settings.voiceSpeed.toFixed(1)}x</Label>
                      <Slider
                    ...
                    <div className="space-y-2">
                      <Label>Pitch Voce: {settings.voicePitch.toFixed(1)}</Label>
                      <Slider
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          {isProcessing && (
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                <span className="text-sm font-medium">Processamento in corso...</span>
      ...
      <Tabs defaultValue="transcriptions" className="w-full">
        <TabsList>
          <TabsTrigger value="transcriptions">
            Trascrizioni ({transcriptions.length})
          </TabsTrigger>
          <TabsTrigger value="translations">
            Traduzioni ({translations.length})
          </TabsTrigger>
        </TabsList>
        ...
        <TabsContent value="translations" className="space-y-4">
          {translations.map((translation) => (
            <Card key={translation.id}>
              <CardHeader>
                <div className="flex items-center justify-between">
                  <CardTitle className="text-base">Traduzione</CardTitle>
                  <div className="flex items-center gap-2">
                    <Badge variant="secondary">
