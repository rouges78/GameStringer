  ...
  return (
    <div className={`space-y-6 ${className}`}>
      ...
      <div className="flex items-center justify-between">
        <h2 className="text-2xl font-bold">Statistiche Dettagliate</h2>
      ...
      <Tabs defaultValue="overview" className="w-full">
        ...
        <TabsContent value="overview" className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">
                  Media: {formatTime(Math.round(globalStats.totalPlaytime / globalStats.totalGames))} per gioco
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium">Giochi Completati</CardTitle>
                <Trophy className="h-4 w-4 text-muted-foreground" />
              </CardHeader>
              <CardContent>
                <div className="text-2xl font-bold">{globalStats.completedGames}</div>
                <p className="text-xs text-muted-foreground">
                  {formatPercentage((globalStats.completedGames / globalStats.totalGames) * 100)} del totale
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">
                  {Math.round(globalStats.totalAchievements / globalStats.totalGames)} per gioco
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium">Streak Corrente</CardTitle>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="flex justify-between items-center">
                  <span className="text-sm text-muted-foreground">Genere Preferito</span>
                  <Badge variant="secondary">{globalStats.favoriteGenre}</Badge>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-muted-foreground">Store Preferito</span>
                ...
                <div className="flex justify-between items-center">
                  <span className="text-sm text-muted-foreground">Sessione Più Lunga</span>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex justify-between items-center">
                  <span className="text-sm text-muted-foreground">Sessioni per Gioco</span>
                  <Badge variant="outline">{Math.round(globalStats.totalSessions / globalStats.totalGames)}</Badge>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-muted-foreground">Durata Media Sessione</span>
        ...
        <TabsContent value="games" className="space-y-6">
          <Card>
            <CardHeader>
              <CardTitle>Top Giochi per Tempo di Gioco</CardTitle>
              <CardDescription>I giochi a cui hai dedicato più tempo</CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="genres" className="space-y-6">
          <Card>
            <CardHeader>
              <CardTitle>Statistiche per Genere</CardTitle>
              <CardDescription>Analisi del tuo tempo di gioco per genere</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
