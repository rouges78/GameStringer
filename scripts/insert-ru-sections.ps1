...
$anchor = "---`n`n## What's New in v1.4.0`n`n### Unified Radix UI`n`nThe UI library has been migrated from individual"
...
The UI library has been migrated from individual
"@

if ($content.Contains($anchor)) {
    $content = $content.Replace($anchor, $sections)
    [System.IO.File]::WriteAllText($file, $content, [System.Text.Encoding]::UTF8)
    Write-Host "RU sections inserted successfully."
} else {
    Write-Host "Anchor not found in RU file!"
    Write-Host "Looking for: $anchor"
}
