...
- **Auto-Select Engine** (NEW v1.9.0): 대상 언어 + 게임 장르에 따라 제공자를 동적으로 순위 매기는 프리셋
...
- **Voice Pipeline**: speech-to-text → 번역 → text-to-speech, **Duration Matching** (NEW v1.9.0) 포함 — 원본 오디오 길이에 맞게 속도 자동 조정
- **Lip Sync** (NEW v1.9.0): 비짐 생성을 위한 Rhubarb 통합, Unity/Unreal 내보내기
- **Gridly CSV Export/Import** (NEW v1.9.0): Gridly/Lokalise/Crowdin 호환 다국어 형식
...
- **Video Extractor** (v1.9.0): AI 업스케일링으로 레트로/현대 게임에서 FMV 비디오 추출 및 변환
