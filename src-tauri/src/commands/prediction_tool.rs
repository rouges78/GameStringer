...
fn get_tool_database() -> Vec<Tool> {
    vec![
        ...
        Tool {
            ...
            supported_engines: vec!["Unity".to_string(), "Unreal Engine".to_string(), "Ren'Py".to_string(), "RPG Maker".to_string(), "GameMaker".to_string(), "Godot".to_string(), "Wolf RPG".to_string(), "Spike Chunsoft".to_string()],
            supported_formats: vec!["txt".to_string(), "json".to_string(), "xml".to_string(), "csv".to_string(), "locres".to_string(), "pck".to_string(), "rpa".to_string(), "data.win".to_string(), "wad".to_string()],
            ...
            description: "Estrazione e reiniezione testo in-app per Unity, Unreal, Ren'Py, RPG Maker, GameMaker, Godot, Wolf RPG e Danganronpa".to_string(),
        },
        Tool {
            name: "UABEA (Unity Assets Bundle Extractor Avalonia)".to_string(),
            ...
            description: "Estrattore di asset Unity per .assets e .bundle. E' quello che l'app scarica davvero (nesrak1/UABEA); l'UABE originale e' archiviato dal 2023".to_string(),
        },
        Tool {
